...
export const CreateProjectButton = ({ onAddNewProject }) => {
  ...
  //Asignamos como fecha mínima para acabar un trabajo la fecha de hoy
  ...
  const handleSubmit = async (e) => {
    ...
    toast.promise(createProject(formData), {
  ...
  return (
    <DialogTrigger>
      <Button
        className='font-medium rounded bg-yellow-400 px-4 py-2 hover:scale-110 hover:font-semibold transition'
